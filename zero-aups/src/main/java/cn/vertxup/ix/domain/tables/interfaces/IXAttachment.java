...
public interface IXAttachment extends Serializable {
     ...
     */
    public void from(cn.vertxup.ix.domain.tables.interfaces.IXAttachment from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IXAttachment
     */
    public <E extends cn.vertxup.ix.domain.tables.interfaces.IXAttachment> E into(E into);
