...
public class SUser extends TableImpl<SUserRecord> {
    ...
    private static final long serialVersionUID = 126532023;

    /**
     * The reference instance of <code>DB_ORIGIN_X.S_USER</code>
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.KEY</code>. 「key」- 用户ID
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.USERNAME</code>. 「username」- 用户登录账号
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.REALNAME</code>. 「realname」- 用户真实姓名
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.EMAIL</code>. 「email」- 用户登录EMAIL地址
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.PASSWORD</code>. 「password」- 用户登录密码
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.CATEGORY</code>. 「category」- 用户分类
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.APP_KEY</code>. 「appKey」- 所属APP的APPKEY
     */
    public final TableField<SUserRecord, String> APP_KEY = createField("APP_KEY", org.jooq.impl.SQLDataType.VARCHAR(128), this, "「appKey」- 所属APP的APPKEY");

    /**
     * The column <code>DB_ORIGIN_X.S_USER.SECRET</code>. 「secret」- 平台为用户分发的密钥
     */
    public final TableField<SUserRecord, String> SECRET = createField("SECRET", org.jooq.impl.SQLDataType.VARCHAR(255), this, "「secret」- 平台为用户分发的密钥");

    /**
     * The column <code>DB_ORIGIN_X.S_USER.MODEL_ID</code>. 「modelId」- 用户所关联的模型identifier，用于描述
     */
    public final TableField<SUserRecord, String> MODEL_ID = createField("MODEL_ID", org.jooq.impl.SQLDataType.VARCHAR(255), this, "「modelId」- 用户所关联的模型identifier，用于描述");

    /**
     * The column <code>DB_ORIGIN_X.S_USER.MODEL_KEY</code>. 「modelKey」- 用户所关联的模型记录ID，用于描述哪一个Model中的记录
     */
    public final TableField<SUserRecord, String> MODEL_KEY = createField("MODEL_KEY", org.jooq.impl.SQLDataType.VARCHAR(36), this, "「modelKey」- 用户所关联的模型记录ID，用于描述哪一个Model中的记录");

    /**
     * The column <code>DB_ORIGIN_X.S_USER.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>DB_ORIGIN_X.S_USER.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<SUserRecord, Boolean> ACTIVE = createField("ACTIVE", org.jooq.impl.SQLDataType.BIT, this, "「active」- 是否启用");

    /**
     * The column <code>DB_ORIGIN_X.S_USER.METADATA</code>. 「metadata」- 附加配置数据
     */
    ...
    /**
     * Create a <code>DB_ORIGIN_X.S_USER</code> table reference
     */
    public SUser() {
    ...
    /**
     * Create an aliased <code>DB_ORIGIN_X.S_USER</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.S_USER_EMAIL, Indexes.S_USER_MOBILE, Indexes.S_USER_MODEL_ID, Indexes.S_USER_PRIMARY, Indexes.S_USER_SECRET, Indexes.S_USER_USERNAME);
    }
    ...
    public List<UniqueKey<SUserRecord>> getKeys() {
        return Arrays.<UniqueKey<SUserRecord>>asList(Keys.KEY_S_USER_PRIMARY, Keys.KEY_S_USER_USERNAME, Keys.KEY_S_USER_MOBILE, Keys.KEY_S_USER_EMAIL, Keys.KEY_S_USER_SECRET, Keys.KEY_S_USER_MODEL_ID);
    }
