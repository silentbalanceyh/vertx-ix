...
public class OUser implements IOUser {
    ...
    private static final long serialVersionUID = -1840242018;
    ...
    public OUser(OUser value) {
        ...
        this.tokenExpired = value.tokenExpired;
    ...
    @Override
    public OUser setToken(byte... token) {
        this.token = token;
        return this;
    }
    ...
    @Override
    public OUser setTokenExpired(LocalDateTime tokenExpired) {
        this.tokenExpired = tokenExpired;
        return this;
    }
