...
public interface IOUser extends Serializable {
     ...
     */
    public IOUser setToken(byte... value);
     ...
     */
    public IOUser setTokenExpired(LocalDateTime value);
     ...
     */
    public void from(cn.vertxup.ix.domain.tables.interfaces.IOUser from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IOUser
     */
    public <E extends cn.vertxup.ix.domain.tables.interfaces.IOUser> E into(E into);
    ...
    default IOUser fromJson(io.vertx.core.json.JsonObject json) {
        ...
        // Omitting unrecognized type java.time.LocalDateTime for column TOKEN_EXPIRED!
